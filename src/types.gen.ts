...
export type MachineConfiguration = {
  ...
  vcpu_count: number;
  /**
   * Which huge pages configuration should be used to back guest memory. "None" uses regular 4K pages. "Transparent" enables THP via madvise(MADV_HUGEPAGE). "2M" uses explicit hugetlbfs 2MB pages.
   */
  huge_pages?: "None" | "Transparent" | "2M";
};
...
export type Metrics = {
  ...
  metrics_path: string;
  /**
   * Whether to emit the microVM instance id (the value passed to the jailer "--id") as a top-level "id" field on each metrics line.
   */
  emit_id?: boolean;
  /**
   * Operator-defined key-value pairs emitted under a top-level "properties" field on each metrics line.
   */
  properties?: {
    [key: string]: string;
  };
...
export type DescribeInstanceError =
  DescribeInstanceErrors[keyof DescribeInstanceErrors];
...
export type DescribeInstanceResponse =
  DescribeInstanceResponses[keyof DescribeInstanceResponses];
...
export type CreateSyncActionError =
  CreateSyncActionErrors[keyof CreateSyncActionErrors];
...
export type DescribeBalloonConfigError =
  DescribeBalloonConfigErrors[keyof DescribeBalloonConfigErrors];
...
export type DescribeBalloonConfigResponse =
  DescribeBalloonConfigResponses[keyof DescribeBalloonConfigResponses];
...
export type DescribeBalloonStatsError =
  DescribeBalloonStatsErrors[keyof DescribeBalloonStatsErrors];
...
export type DescribeBalloonStatsResponse =
  DescribeBalloonStatsResponses[keyof DescribeBalloonStatsResponses];
...
export type PatchBalloonStatsIntervalError =
  PatchBalloonStatsIntervalErrors[keyof PatchBalloonStatsIntervalErrors];
...
export type StartBalloonHintingError =
  StartBalloonHintingErrors[keyof StartBalloonHintingErrors];
...
export type DescribeBalloonHintingError =
  DescribeBalloonHintingErrors[keyof DescribeBalloonHintingErrors];
...
export type DescribeBalloonHintingResponse =
  DescribeBalloonHintingResponses[keyof DescribeBalloonHintingResponses];
...
export type StopBalloonHintingError =
  StopBalloonHintingErrors[keyof StopBalloonHintingErrors];
...
export type PutGuestBootSourceError =
  PutGuestBootSourceErrors[keyof PutGuestBootSourceErrors];
...
export type PutCpuConfigurationError =
  PutCpuConfigurationErrors[keyof PutCpuConfigurationErrors];
...
export type PatchGuestDriveByIdError =
  PatchGuestDriveByIdErrors[keyof PatchGuestDriveByIdErrors];
...
export type PutGuestDriveByIdError =
  PutGuestDriveByIdErrors[keyof PutGuestDriveByIdErrors];
...
export type PatchGuestPmemByIdData = {
  /**
...
export type PatchGuestPmemByIdErrors = {
  /**
...
export type PatchGuestPmemByIdError =
  PatchGuestPmemByIdErrors[keyof PatchGuestPmemByIdErrors];

export type PatchGuestPmemByIdResponses = {
  /**
   * Pmem device updated
   */
  204: unknown;
...
export type PutGuestPmemByIdError =
  PutGuestPmemByIdErrors[keyof PutGuestPmemByIdErrors];
...
export type GetMachineConfigurationError =
  GetMachineConfigurationErrors[keyof GetMachineConfigurationErrors];
...
export type GetMachineConfigurationResponse =
  GetMachineConfigurationResponses[keyof GetMachineConfigurationResponses];
...
export type PatchMachineConfigurationError =
  PatchMachineConfigurationErrors[keyof PatchMachineConfigurationErrors];
...
export type PutMachineConfigurationError =
  PutMachineConfigurationErrors[keyof PutMachineConfigurationErrors];
...
export type PutEntropyDeviceError =
  PutEntropyDeviceErrors[keyof PutEntropyDeviceErrors];
...
export type PutSerialDeviceError =
  PutSerialDeviceErrors[keyof PutSerialDeviceErrors];
...
export type GetMemoryHotplugError =
  GetMemoryHotplugErrors[keyof GetMemoryHotplugErrors];
...
export type GetMemoryHotplugResponse =
  GetMemoryHotplugResponses[keyof GetMemoryHotplugResponses];
...
export type PatchMemoryHotplugError =
  PatchMemoryHotplugErrors[keyof PatchMemoryHotplugErrors];
...
export type PutMemoryHotplugError =
  PutMemoryHotplugErrors[keyof PutMemoryHotplugErrors];
...
export type PatchGuestNetworkInterfaceByIdError =
  PatchGuestNetworkInterfaceByIdErrors[keyof PatchGuestNetworkInterfaceByIdErrors];
...
export type PutGuestNetworkInterfaceByIdError =
  PutGuestNetworkInterfaceByIdErrors[keyof PutGuestNetworkInterfaceByIdErrors];
...
export type GetFirecrackerVersionError =
  GetFirecrackerVersionErrors[keyof GetFirecrackerVersionErrors];
...
export type GetFirecrackerVersionResponse =
  GetFirecrackerVersionResponses[keyof GetFirecrackerVersionResponses];
...
export type GetExportVmConfigError =
  GetExportVmConfigErrors[keyof GetExportVmConfigErrors];
...
export type GetExportVmConfigResponse =
  GetExportVmConfigResponses[keyof GetExportVmConfigResponses];
